...
public class Surface extends Design {
	...
	public Surface(PApplet p, int x, int y, int z) {
		...
		this.mat = new MatricePositions(300, this.coefs.length, this.largeur);
	...
	public void initSurface() {
		...
		this.modifSurface();
		if (surface.getChildCount() == this.file.getsizeMax() - 1) {
			complet = true;
		}
	...
	public void modifSurface() {
		...
		for (int j = 0; j < surface.getChildCount(); j++) {
