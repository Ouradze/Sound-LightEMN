...
public class Surface3D extends Design {
	...
	public void creerUniteSurface(int i, int k, String ordre) {
		...
		case Surface3D.Surface: // ADBC
			p.vertex(this.points[Surface3D.seq[0]][0],
					this.points[Surface3D.seq[0]][1],
					this.points[Surface3D.seq[0]][2]);
			p.vertex(this.points[Surface3D.seq[1]][0],
					this.points[Surface3D.seq[1]][1],
					this.points[Surface3D.seq[1]][2]);
			p.vertex(this.points[Surface3D.seq[2]][0],
					this.points[Surface3D.seq[2]][1],
					this.points[Surface3D.seq[2]][2]);
			p.vertex(this.points[Surface3D.seq[3]][0],
					this.points[Surface3D.seq[3]][1],
					this.points[Surface3D.seq[3]][2]);
			break;
		case Surface3D.Lignes:
			p.vertex(this.points[0][0], this.points[0][1], this.points[0][2]);
			p.vertex(this.points[1][0], this.points[1][1], this.points[1][2]);
			p.vertex(this.points[3][0], this.points[3][1], this.points[3][2]);
			p.vertex(this.points[2][0], this.points[2][1], this.points[2][2]);
			break;
